					...
					<form method="post" id="ajax_post" action="" name="form"
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-10">
								...
								<input name="nome" type="text" required="required"
									...
									placeholder="Qual o nome do membro?">
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-10">
								...
								<input name="endereco" type="text" required="required"
									class="form-control input-lg" id="inputPassword3"
									placeholder="Qual o endereço do membro?">
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-10">
								...
								<input name="telefone" id="telefone" type="tel"
									...
									placeholder="Qual o telefone do membro?">
							</div>
						</div>
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-10">
								...
								<input name="email" type="email" required="required"
									...
									class="form-control input-lg" id="inputPassword3"
									placeholder="Qual o email do membro?">
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-2">
								...
								<label for="inputEmail3" class="control-label">Nº de Membros</label>
							</div>
							...
							<div class="col-sm-10">
								...
								<input name="quantidade" type="text" required="required"
									...
									class="form-control input-lg" id="inputPassword3"
									placeholder="Em caso de assistidos, quantos membros há na família?">
						...
						<div class="form-group has-feedback">
							...
							<div class="col-sm-2">
								...
								<label for="inputEmail3" class="control-label">Responsável</label>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-6 text-center">
								...
								<button type="submit" id="post" class="btn btn-lg btn-success"
									href="addMembro.php">Enviar</button>
							</div>
